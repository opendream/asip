...
def received_funding_render_reference(received_funding, display_edit_link=True, field_name='received_fundings'):
    ...
    if 'receive' in field_name:
        ...
        html = '<span class="reference-span">%s <strong>%s %s</strong> from</span>' % (verb_display, received_funding.amount, settings.CURRENCY)
        ...
        html = '<span class="reference-span">%s <strong>%s %s</strong> to</span>' % (verb_display, received_funding.amount, settings.CURRENCY)
