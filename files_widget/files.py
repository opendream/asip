...
def manage_files_on_disk(sender, instance, **kwargs):
    ...
    from fields import ImagesField, ImageField, XFileField, XFilesField
    fields = [field for field in sender._meta.fields if type(field) in [ImagesField, ImageField, XFileField, XFilesField]]
