                ...
                if value is not None or field_object.null:
                    ...
                    if not field_object.is_related:
                        ...
                        if value is not None:
                            ...
                            obj = value.obj
                            if hasattr(obj, 'get_deep_inst'):
                                obj = obj.get_deep_inst()
                            # print setattr(bundle.obj, field_object.attribute, obj)

                            try:
                                setattr(bundle.obj, field_object.attribute, obj)
                                print 'getattr(bundle.obj, field_object.attribute)', getattr(bundle.obj, field_object.attribute)
                            except (ValueError, ObjectDoesNotExist):
                                bundle.related_objects_to_save[field_object.attribute] = obj
